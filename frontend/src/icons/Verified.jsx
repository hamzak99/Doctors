const IconVerified = ({ width = "16", height = "16" }) => (
    <svg
      viewBox="0 0 16 16"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <g fill="#0039e6">
          <path d="M11.28 5.72a.75.75 0 010 1.06l-4 4a.75.75 0 01-1.06 0l-1.5-1.5a.75.75 0 011.06-1.06l.97.97 3.47-3.47a.75.75 0 011.06 0z"></path>
          <path
            fillRule="evenodd"
